          ...
          >
            ...
            <div className="space-y-6 text-lg text-white/70 leading-relaxed">
              ...
              <p>
                ...
                <strong className="text-white">
                  são desenvolvidas com programação
                </strong>{" "}
                personalizada,{" "}
                <strong className="text-white">
                  sem depender de construtores "arrasta e solta".{" "}
                </strong>
                Isso nos permite criar soluções mais leves, otimizadas e
                alinhadas às necessidades específicas de cada projeto.
              </p>
              <p>
                Mais do que um layout bonito, entregamos uma base tecnológica
                sólida para suas vendas, utilizando{" "}
                <strong className="text-white">tecnologias modernas</strong>{" "}
                como React e Next.js, garantindo uma experiência rápida e
                estável para seus usuários.
              </p>
            </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/50">
                    Sem "arrasta e solta". Controle total do código.
                  </p>
                </div>
              </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#12141B] to-[#0A0C10] p-8 flex flex-col">
                ...
                <div className="font-mono text-sm space-y-3 text-white/40 overflow-hidden">
                  ...
                  <div className="flex">
                    ...
                    <span className="text-yellow-400">boostSales</span>(client){" "}
                    {"{"}
                  </div>
                  <div className="flex pl-4">
