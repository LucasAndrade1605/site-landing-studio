import { Rocket, Zap, Smartphone, Globe, BarChart, Layout } from "lucide-react";
...
const features = [
  {
    ...
    description: "Carregamento instantâneo e otimização total para Core Web Vitals do Google."
  },
  {
    icon: Smartphone,
    title: "Mobile First",
    description: "Design pensado primeiramente para a experiência em dispositivos móveis."
  },
  {
    icon: Zap,
    title: "Foco em Conversão",
    description: "Layouts estratégicos guiados por psicologia de vendas e neuromarketing."
  },
  {
    icon: Layout,
    title: "Design Premium",
    description: "Estética refinada que eleva a percepção de valor da sua marca."
  },
  {
    icon: Globe,
  ...
  },
  {
    ...
    description: "Integração nativa com pixel do Facebook, GA4 e ferramentas de tracking."
  }
];

export function Features() {
  return (
    <section id="services" className="py-24 bg-[#050608] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-primary font-medium tracking-widest text-sm uppercase mb-4 block">Nossa Expertise</span>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Tudo que você precisa para <span className="text-primary">escalar</span></h2>
          <p className="text-white/60 text-lg">
            Não criamos apenas páginas bonitas. Construímos máquinas de vendas validadas para o seu negócio.
          </p>
        </div>
